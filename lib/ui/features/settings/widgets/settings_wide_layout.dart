...
/// 宽屏设置使用单一连续表单，避免将常规偏好拆成互相竞争的卡片。
class SettingsWideLayout extends StatelessWidget {
  const SettingsWideLayout({super.key, required this.controls});
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      padding: const EdgeInsets.only(bottom: WorkspaceLayoutMetrics.sectionGap),
